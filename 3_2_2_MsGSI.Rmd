...
mixture_genos <-read_excel("input_files/JSOES_2024_May_Genotypes.xlsx", sheet = "Mix258")
...
write.csv(Ind_Assign_Est_Northern, file = "output/Indiv_Assignments_North.csv", row.names = FALSE)
write.csv(Ind_Assign_Est_Columbia, file = "output/Indiv_Assignments_Columbia.csv", row.names = FALSE)
write.csv(Ind_Assign_Est_Southern, file = "output/Indiv_Assignments_South.csv", row.names = FALSE)
